...
{
    public class CSSPolicyMasterMap : EntityTypeConfiguration<CSSPolicyMaster>
    {
        public CSSPolicyMasterMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.HasRequired(t => t.User1)
                .WithMany(t => t.CSSPolicyMasters1)
